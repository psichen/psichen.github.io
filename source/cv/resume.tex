...
\section{Education}
\begin{twocolentry}{ 2013 – 2019 }
\textbf{Peking University}, Ph.D. in Chemical biology / Supervisor: Xin Sheng Zhao
\end{twocolentry}
\begin{twocolentry}{ 2009 – 2013 }
\textbf{Sun Yat-sen University}, B.Sc. in Chemistry
\end{twocolentry}

\section{Work Experience}
\begin{twocolentry}{2021 – Present}
\textbf{Weill Cornell Medicine}, Postdoctoral researcher / Supervisor: Simon Scheuring
\end{twocolentry}
...
\section{Teaching}
\begin{twocolentry}{ fall semester, 2017 }
        \textbf{General chemical experiments (B)} Teaching Assistant
\end{twocolentry}

\section{Research Field}
\begin{onecolentry}
        \textbf{Biology} membrane protein, membrane-associated protein, conformational dynamics, supermolecular assembly
\end{onecolentry}

\vspace{0.2 cm}

\begin{onecolentry}
        \textbf{Deep learning} self-supervised AFM imaging algorithm development
\end{onecolentry}
